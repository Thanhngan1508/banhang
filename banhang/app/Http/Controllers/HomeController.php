...
class HomeController extends Controller
{
    ...
    public function send_mail(){
         //send mail
                $to_name = "Organic";
                $to_email = "thanhngan17593@gmail.com";//send to this email
               
             
                $data = array("name"=>"Tài khoản Khách hàng","body"=>'Nội dung mail'); 
    ...
    public function index(Request $request){
        ...
        //seo 
        $meta_desc = "Trang mua sắm trực tuyến phổ biến trong ngành hàng mỹ phẩm với nhiều sản phẩm chính hãng như kem dưỡng da, kem chống nắng,..."; 
        $meta_keywords = "my pham, mỹ phẩm";
        $meta_title = "Organic.vn | Mỹ Phẩm - Clinic & Spa";
