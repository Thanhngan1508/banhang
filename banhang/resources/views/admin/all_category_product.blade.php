...
@section('admin_content')
  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <p style="font-size: 20px; color: #a32b2b"><b>Danh mục sản phẩm</b></p>
    </div>
    ...
    <div class="table-responsive">
      ...
      <form action="{{url('import-csv')}}" method="POST" enctype="multipart/form-data">
        ...
        <input type="file" name="file" accept=".xlsx" style="margin-left: 15px; margin-top: 20px"><br>
    ...
    <!-----export data---->
       ...
       <form action="{{url('export-csv')}}" method="POST">
          @csrf
       <input type="submit" value="Export file Excel" name="export_csv" class="btn btn-primary" style="margin-left: -10px">
       </form>
      </div>
