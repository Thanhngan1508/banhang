            ...
            <div class="col-lg-12">
                    <section class="panel">
                        <header class="panel-heading">
                           <p style="font-size: 20px; color: #a32b2b"><b>CẬP NHẬT DANH MỤC SẢN PHẨM</b></p>
                        </header>
                         <?php
                        ...
                        <div class="panel-body"> 
                            ...
                            <div class="position-center">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="hidden" value="{{$edit_value->slug_category_product}}" name="slug_category_product" class="form-control" id="convert_slug" >
                                </div>
                                <button type="submit" name="update_category_product" class="btn btn-info" style="font-size: 18px; margin:auto; display:block;">Cập nhật</button>
                                </form>
                            </div>
                            @endforeach
                        </div>
