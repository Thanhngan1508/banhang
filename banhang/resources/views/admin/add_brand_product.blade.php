                        ...
                        <div class="panel-body">
                            ...
                            <div class="position-center">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="brand_product_name" class="form-control" class="form-control" data-validation="length" data-validation-length="min1" data-validation-error-msg="Điền tên thương hiệu" onkeyup="ChangeToSlug();" id="slug" placeholder="Tên danh mục">
                                </div>
                               ...
                               <div class="form-group">
                                    ...
                                    <input type="hidden" name="brand_slug" class="form-control" id="convert_slug" placeholder="Slug">
                                </div>
